package kafka;
/*
https://github.com/confluentinc/examples/blob/3.3.0-post/kafka-clients/consumer/src/main/java/io/confluent/examples/consumer/SimpleConsumerExample.java
*/
...
public class SimpleConsumerExample {
    ...
    public static void main(String args[]) {
        args = new String[]{"10", "MpjsLogTest", "1", "kafka001", "9092"};
        if (args.length != 5) {
